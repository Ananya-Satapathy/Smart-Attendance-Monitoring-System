...
image = CurrentFolder+'/nikita.png'
image2 = CurrentFolder+'/ananya.png'
image3 = CurrentFolder+'/Biswa.png'
image4 = CurrentFolder+'Blooma/.png'
image5 = CurrentFolder+'/Anuska.png'
...
known_face_encodings = [
    ...
    person3_face_encoding,person4_face_encoding,person5_face_encoding
]
known_face_names = [
    person1_name,person2_name,person3_name,person4_name,person5_name
]
